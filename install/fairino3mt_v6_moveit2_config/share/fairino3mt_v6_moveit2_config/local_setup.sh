...
: ${AMENT_CURRENT_PREFIX:="/home/hjkim/gnu_ws/install/fairino3mt_v6_moveit2_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fairino3mt_v6_moveit2_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fairino3mt_v6_moveit2_config/environment/path.sh"
